...
var Track = React.createClass({
	...
	render: function(){
		...
		return <div className="track">
							<span className="artwork_url"><img src={this.props.track.track.artwork_url} /></span>
							<span className="title">{this.props.track.track.title} </span>
							<span className="artist"><b>{this.props.track.track.artist}</b></span></div>;
	}
});
